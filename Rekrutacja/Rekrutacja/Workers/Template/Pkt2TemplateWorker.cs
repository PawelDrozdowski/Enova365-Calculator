...
[assembly: Worker(typeof(Pkt2TemplateWorker), typeof(Pracownicy))]
namespace Rekrutacja.Workers.Template
{
    public partial class Pkt2TemplateWorker
    {
        ...
        [Context]
        public Pkt2WorkerParametry Parametry { get; set; }
        //Atrybut Action - Wywołuje nam metodę która znajduje się poniżej
        [Action("Kalkulator 2",
           Description = "Prosty kalkulator Pkt2",
           Priority = 10,
