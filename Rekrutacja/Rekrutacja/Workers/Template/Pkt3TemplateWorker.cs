...
[assembly: Worker(typeof(Pkt3TemplateWorker), typeof(Pracownicy))]
namespace Rekrutacja.Workers.Template
{
    public partial class Pkt3TemplateWorker
    {
        ...
        [Context]
        public Pkt3WorkerParametry Parametry { get; set; }
        //Atrybut Action - Wywołuje nam metodę która znajduje się poniżej
        [Action("Kalkulator 3",
           Description = "Prosty kalkulator Pkt3",
           Priority = 10,
